              ...
              <div className="content-page-header ">
                ...
                <div className="list-btn">
                  <ul className="filter-list">
                    {/* <li>
                      <Link className="btn btn-filters w-auto popup-toggle me-2" to='/create-godown'>
                        Create Godown{" "}
                      </Link>
                    </li> */}
                    <div className="button-list me-2">
                      {/* Responsive modal */}
                      <button type="button" className="btn btn-primary waves-effect waves-light mt-1 me-1" data-bs-toggle="modal"
                    ...
                    <div className="button-list me-2">
                      {/* Responsive modal */}
                      <button type="button" className="btn btn-primary waves-effect waves-light mt-1 me-1" data-bs-toggle="modal"
                        data-bs-target="#con-close-modal1">
                        Edit Godown
                      </button>
                    </div>
                    <div
                            ...
                            <div className="row">
                              <div className="col-lg-12 col-md-6 col-sm-12">
                                <div className="mb-3 form-group">
                                  <label>
                                    Godown Name <span className="accountprofilesettings-start-mark">*</span>
                                  </label>
                                  <input
                                    type="text"
