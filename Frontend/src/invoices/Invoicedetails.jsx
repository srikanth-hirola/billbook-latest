...
const Invoicedetails = () => {
  ...
  const handleEmailShare = () => {
    ...
    const body = "Hello, check out this invoice:";
    const invoiceHTML = document.getElementById("invoiceContent").innerHTML; // Get the HTML content of the invoice template
  
    // Concatenate body with HTML content
